...
| Option | Description |
|--------|-------------|
| `--from-dir PATH` | Source directory containing the files to copy |
| `--to-dir PATH` | Destination directory for copied files |
| `--from-file PATH` | Path to the MD5 manifest file |
